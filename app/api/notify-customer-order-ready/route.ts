      ...
      html: `
        <div style="background:#f8fafc;padding:24px;font-family:Arial,sans-serif">
          <div style="max-width:600px;margin:0 auto">
            ...
            <div style="background:white;border-radius:12px;padding:20px;margin-bottom:16px">
              <h3 style="margin:0 0 12px 0">Pickup Instructions</h3>
              <p style="margin:0">Please pick up your order directly from <strong>${order.restaurant_name}</strong>.</p>
              <p style="margin:4px 0;color:#475569">The restaurant will provide pickup details on arrival.</p>
            </div>
